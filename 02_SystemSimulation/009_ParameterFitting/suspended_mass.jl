...
# The aim of this model is to demostrate the calibration of parameters based on data
...
odeprob = ODEProblem(odesys, [xₘ => xₘ₀, ẋₘ => 0], tspan, [m => 10, k => 1000, c => 30, g => 9.81, xₘ₀ => 1])
...
p_min = [0, 9.80, 100.0, 29.5, 0.5]
p_max = [2, 9.82, 5000.0, 30.5, 500.0]
